            ...
            steps{
                ...
                script{
                    ...
                    sshagent(['SSHEC2']) {
                        ...
                        sh "ssh -o StrictHostKeyChecking=no ubuntu@ubuntu@ec2-54-152-159-155.compute-1.amazonaws.com 'cd /home/ubuntu/ && docker image build -t ${Dockeraccount}/${ImageName}:${ImageTag} -f Dockerfile .'"
